...
public interface CTBNWFBClient {
	...
	CTBNWFBv1RouteStopListResponse getCTBNWFBv1RouteStopList(@PathVariable("company") String company,@PathVariable("route") String route, @PathVariable("direction") String direction);

	@RequestMapping(method = RequestMethod.GET, value = "/v1.1/transport/citybus-nwfb/eta/{company}/{stopId}/{route}")
	CTBNWFBv1RouteStopEtaResponse getCTBNWFBv1RouteStopEta(@PathVariable("company") String company, @PathVariable("stopId") String stopId,@PathVariable("route") String route);
